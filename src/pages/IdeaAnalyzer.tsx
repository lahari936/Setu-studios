    ...
    <div className="py-8">
      <div className="w-full px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex p-3 rounded-full bg-gradient-to-br from-orange-300 via-orange-400 to-orange-500 mb-4 animate-idea-spark">
            <Brain size={24} className="text-white" />
          </div>
          <h1 className="text-3xl md:text-4xl font-bold mb-4 gradient-text-entrepreneur animate-startup-rise">Idea Analyzer</h1>
          <p className={`text-lg max-w-2xl mx-auto ${isDark ? 'text-gray-300' : 'text-gray-600'} animate-business-growth`}>
        ...
        {!showResults ? (
          <>
            {/* Form Section */}
            <AnimatedCard className="mb-8 max-w-2xl mx-auto startup-card-hover">
              <h2 className="text-xl font-bold mb-4 gradient-text-entrepreneur animate-scale-up">Tell Us About Your Startup Idea</h2>
              <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    ...
                    value={formData.ideaName}
                      ...
                      required
                      className={`w-full px-4 py-3 rounded-lg border-2 focus:outline-none focus:ring-2 focus:ring-orange-300/30 focus:border-orange-300 transition-all ${
                ...
                <button
                  ...
                  className={`w-full py-4 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center space-x-2 ${
                    isAnalyzing || !formData.ideaName || !formData.ideaDescription
                      ...
                      : 'bg-gradient-to-r from-orange-300 via-orange-400 to-orange-500 hover:from-orange-400 hover:via-orange-500 hover:to-orange-600 hover:scale-105 shadow-lg hover:shadow-orange-400/30'
                  } text-white`}
                >
                  {isAnalyzing ? (
                    <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <AnimatedCard className="text-center startup-card-hover">
                <TrendingUp size={32} className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 via-orange-400 to-orange-500 mx-auto mb-4 animate-idea-spark" />
                <h3 className="text-lg font-semibold mb-2 gradient-text-entrepreneur animate-scale-up">Market Analysis</h3>
                <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'} animate-business-growth`}>
                  Comprehensive market size, trends, and opportunity assessment
                </p>
              </AnimatedCard>

              <AnimatedCard className="text-center startup-card-hover">
                <Users size={32} className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 via-orange-400 to-orange-500 mx-auto mb-4 animate-innovation-pulse" />
                <h3 className="text-lg font-semibold mb-2 gradient-text-entrepreneur animate-scale-up">Competition Research</h3>
                <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'} animate-business-growth`}>
              ...
              <AnimatedCard className="text-center startup-card-hover">
                <Target size={32} className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 via-orange-400 to-orange-500 mx-auto mb-4 animate-success-glow" />
                <h3 className="text-lg font-semibold mb-2 gradient-text-entrepreneur animate-scale-up">Strategic Recommendations</h3>
                <p className={`text-sm ${isDark ? 'text-gray-400' : 'text-gray-600'} animate-business-growth`}>
          ...
          <div className="space-y-8">
            ...
            <AnimatedCard className="text-center startup-card-hover">
              <div className="flex items-center justify-center space-x-4 mb-4">
                <Brain size={32} className="text-transparent bg-clip-text bg-gradient-to-r from-orange-300 via-orange-400 to-orange-500 animate-idea-spark" />
                  <h2 className="text-2xl font-bold gradient-text-entrepreneur animate-startup-rise">AI Analysis Complete!</h2>
              </div>
              <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'} animate-business-growth`}>
            ...
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-black to-gray-800 p-8 text-white mb-12">
              <div className="absolute inset-0 bg-gradient-to-br from-orange-300/15 via-orange-400/10 to-orange-500/15"></div>
              <div className="relative z-10">
                <div className="flex items-center space-x-4 mb-8">
                  <div className="p-4 bg-gradient-to-br from-orange-300 via-orange-400 to-orange-500 rounded-2xl shadow-lg shadow-orange-400/30">
                    <Brain size={32} className="text-white" />
                  </div>
                  <div>
                    <h2 className="text-4xl font-bold bg-gradient-to-r from-orange-300 via-orange-400 to-orange-500 bg-clip-text text-transparent">Executive Summary</h2>
                ...
                <div className="space-y-8">
                  <div className="bg-gradient-to-r from-gray-800/50 to-gray-700/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-600/30">
                    <div className="flex items-center space-x-3 mb-4">
                      <div className="w-3 h-3 bg-gradient-to-r from-orange-300 to-orange-400 rounded-full animate-pulse shadow-lg shadow-orange-300/50"></div>
                      <h3 className="text-2xl font-bold bg-gradient-to-r from-orange-300 to-orange-400 bg-clip-text text-transparent">Overview</h3>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-orange-900 to-black p-8 text-white mb-12">
                <div className="absolute inset-0 bg-gradient-to-br from-orange-300/25 via-orange-400/20 to-orange-500/25"></div>
                <div className="relative z-10">
                  <div className="flex items-center space-x-4 mb-8">
                    <div className="p-4 bg-gradient-to-br from-orange-300 via-orange-400 to-orange-500 rounded-2xl shadow-lg shadow-orange-400/40">
                      <Target size={32} className="text-white" />
                    </div>
                    <div>
                      <h3 className="text-4xl font-bold bg-gradient-to-r from-orange-300 via-orange-400 to-orange-500 bg-clip-text text-transparent">Go-to-Market Strategy</h3>
                      <p className="text-gray-300 text-lg">Launch & Distribution Strategy</p>
                    </div>
                  </div>
                  
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="bg-black/50 backdrop-blur-sm rounded-2xl p-8 border border-orange-400/40" style={{backgroundImage: 'linear-gradient(to bottom right, rgba(253, 186, 116, 0.05), rgba(249, 115, 22, 0.05))'}}>
                      <div className="flex items-center space-x-3 mb-6">
                        <div className="w-3 h-3 bg-gradient-to-r from-orange-300 to-orange-400 rounded-full animate-pulse shadow-lg shadow-orange-300/50"></div>
                        <h4 className="text-2xl font-bold bg-gradient-to-r from-orange-300 to-orange-400 bg-clip-text text-transparent">Launch Plan</h4>
                      </div>
                      <p className="text-gray-200 text-lg leading-relaxed">
                        {analysisData.go_to_market_strategy.launch_plan}
                      </p>
              ...
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-yellow-900 to-black p-8 text-white mb-12">
                <div className="absolute inset-0 bg-gradient-to-br from-yellow-600/20 via-orange-300/20 to-orange-500/20"></div>
                <div className="relative z-10">
                  <div className="flex items-center space-x-4 mb-8">
                    <div className="p-4 bg-gradient-to-br from-yellow-500 via-orange-300 to-orange-500 rounded-2xl shadow-lg shadow-orange-300/40">
                      <BarChart3 size={32} className="text-white" />
                    </div>
                    <div>
                      <h3 className="text-4xl font-bold bg-gradient-to-r from-yellow-400 via-orange-300 to-orange-500 bg-clip-text text-transparent">Finance & Funding</h3>
                  ...
                  <div className="space-y-8">
                    ...
                    {/* Monetization Plan */}
                    <div className="bg-gradient-to-br from-gray-800/50 via-orange-900/30 to-orange-900/30 backdrop-blur-sm rounded-2xl p-8 border border-orange-400/40" style={{backgroundImage: 'linear-gradient(to bottom right, rgba(253, 186, 116, 0.05), rgba(249, 115, 22, 0.05))'}}>
                      <div className="flex items-center space-x-3 mb-6">
                        <div className="w-3 h-3 bg-gradient-to-r from-orange-300 to-orange-400 rounded-full animate-pulse shadow-lg shadow-orange-300/50"></div>
                        <h4 className="text-2xl font-bold bg-gradient-to-r from-orange-300 to-orange-400 bg-clip-text text-transparent">Monetization Plan</h4>
                      </div>
                      <p className="text-gray-200 text-xl leading-relaxed">
                        {analysisData.finance.monetization_plan}
                      </p>
                      ...
                      <div className="space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                          <div className="text-center p-8 bg-black/50 rounded-2xl border border-yellow-500/30">
                            <div className="w-16 h-16 bg-gradient-to-br from-yellow-500 via-orange-300 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg shadow-orange-300/40">
                          ...
                          <div className="text-center p-8 bg-black/50 rounded-2xl border border-orange-400/40">
                            <div className="w-16 h-16 bg-gradient-to-br from-orange-300 via-orange-400 to-orange-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg shadow-orange-300/40">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {analysisData.finance.funding_stage_and_ask.use_of_funds.map((use, index) => (
                              <div key={index} className="flex items-center space-x-4 p-6 bg-black/50 rounded-xl border border-red-500/20">
                                <div className="w-4 h-4 bg-gradient-to-r from-red-400 via-orange-300 to-orange-400 rounded-full shadow-lg shadow-orange-300/50"></div>
              ...
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-purple-900 to-black p-8 text-white mb-12">
                ...
                <div className="relative z-10">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    {/* Threats */}
                    <div className="bg-gradient-to-br from-orange-900/30 via-orange-900/20 to-yellow-900/30 backdrop-blur-sm rounded-2xl p-8 border border-orange-400/40">
                      <div className="flex items-center space-x-3 mb-6">
                        <div className="w-6 h-6 bg-gradient-to-r from-orange-300 via-orange-400 to-yellow-400 rounded-full shadow-lg shadow-orange-300/50"></div>
                        <h4 className="font-bold text-white text-2xl">Threats</h4>
                      </div>
                      <ul className="space-y-4">
                        {analysisData.swot_analysis.threats.map((threat, index) => (
                          <li key={index} className="flex items-start space-x-3 p-3 bg-black/50 rounded-lg">
                            <div className="w-3 h-3 bg-gradient-to-r from-orange-300 to-orange-400 rounded-full mt-2 flex-shrink-0 shadow-lg shadow-orange-300/50"></div>
              ...
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-yellow-900 to-black p-8 text-white mb-12">
                ...
                <div className="relative z-10">
                  <div className="flex items-center space-x-4 mb-8">
                    ...
                    <div>
                      <h3 className="text-4xl font-bold bg-gradient-to-r from-yellow-400 via-orange-300 to-orange-500 bg-clip-text text-transparent">1-Minute Elevator Pitch</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-black/50 backdrop-blur-sm rounded-2xl p-8 border border-yellow-500/30">
                      <div className="flex items-center space-x-4 mb-6">
                        <div className="w-8 h-8 bg-gradient-to-r from-yellow-400 via-orange-300 to-orange-400 rounded-full shadow-lg shadow-orange-300/50"></div>
                    ...
                    <div className="bg-black/50 backdrop-blur-sm rounded-2xl p-8 border border-orange-400/40" style={{backgroundImage: 'linear-gradient(to bottom right, rgba(253, 186, 116, 0.05), rgba(249, 115, 22, 0.05))'}}>
                      <div className="flex items-center space-x-4 mb-6">
                        <div className="w-8 h-8 bg-gradient-to-r from-orange-300 via-orange-400 to-red-400 rounded-full shadow-lg shadow-orange-300/50"></div>
              ...
              <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 via-orange-900 to-black p-8 text-white mb-12">
                <div className="absolute inset-0 bg-gradient-to-br from-orange-300/25 via-orange-400/20 to-pink-600/20"></div>
                <div className="relative z-10">
                  <div className="text-center mb-8">
                    <div className="flex items-center justify-center space-x-4 mb-6">
                      <div className="p-4 bg-gradient-to-br from-orange-300 via-orange-400 to-pink-500 rounded-2xl shadow-lg shadow-orange-300/40">
                        <Target size={32} className="text-white" />
                      </div>
                      <h3 className="text-4xl font-bold bg-gradient-to-r from-orange-300 via-orange-400 to-pink-400 bg-clip-text text-transparent">Ready to Take Action?</h3>
                    </div>
              ...
              <button 
                      ...
                      className="group/btn relative px-12 py-6 bg-gradient-to-r from-orange-300/25 via-orange-400/20 to-pink-500/20 backdrop-blur-sm text-white rounded-2xl font-bold hover:from-orange-300/35 hover:via-orange-400/30 hover:to-pink-500/30 transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-orange-300/35 flex items-center justify-center space-x-4 border border-orange-400/40"
              >
